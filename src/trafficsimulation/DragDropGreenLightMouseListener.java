...
public class DragDropGreenLightMouseListener extends MouseAdapter {
    
    private DragDropGreenLight reallight;
    private Road road;

    public DragDropGreenLightMouseListener(DragDropGreenLight reallight, Road road) {
